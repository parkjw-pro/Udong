...
3. https를 사용하기위해서는 도메인에 대한 ssl인증 받기(aws에서 인증)
...
우리 프로젝트에 있는 geolocation기능은 보안문제 때문에 크롬 특정버전 이후로부터는 

http환경에서사용 할 수 없습니다.

하지만 기능을 포기할 순 없으니 https로 개설하여 기능을 적용시켜 봅니다.
...
AWS 리전을 꼭 확인하시기 바랍니다. 해당서비스가 제공될 지역에서 인증을 받아야한다!
