...
ALTER TABLE `group_post` ADD CONSTRAINT `FK_group_TO_group_post_1` FOREIGN KEY (
	`group_id`
)
REFERENCES `group` (
	`group_id`
...
ALTER TABLE `promotion` ADD CONSTRAINT `FK_user_TO_promotion_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `prom_comment` ADD CONSTRAINT `FK_promotion_TO_prom_comment_1` FOREIGN KEY (
	`prom_id`
)
...
ALTER TABLE `prom_comment` ADD CONSTRAINT `FK_user_TO_prom_comment_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `group_post_like` ADD CONSTRAINT `FK_user_TO_group_post_like_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `group_post_like` ADD CONSTRAINT `FK_group_post_TO_group_post_like_1` FOREIGN KEY (
	`post_id`
)
REFERENCES `group_post` (
	`post_id`
);

ALTER TABLE `group_post_like` ADD CONSTRAINT `FK_group_post_TO_group_post_like_2` FOREIGN KEY (
	`group_id`
)
REFERENCES `group_post` (
	`group_id`
...
ALTER TABLE `group_post_comment` ADD CONSTRAINT `FK_group_post_TO_group_post_comment_1` FOREIGN KEY (
	`post_id`
)
REFERENCES `group_post` (
	`post_id`
...
ALTER TABLE `group_post_comment` ADD CONSTRAINT `FK_group_post_TO_group_post_comment_2` FOREIGN KEY (
	`group_id`
)
REFERENCES `group_post` (
	`group_id`
...
ALTER TABLE `group_post_comment` ADD CONSTRAINT `FK_user_TO_group_post_comment_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `group_post_file` ADD CONSTRAINT `FK_group_post_TO_group_post_file_1` FOREIGN KEY (
	`post_id`
)
REFERENCES `group_post` (
	`post_id`
...
ALTER TABLE `group_post_file` ADD CONSTRAINT `FK_group_post_TO_group_post_file_2` FOREIGN KEY (
	`group_id`
)
REFERENCES `group_post` (
	`group_id`
...
ALTER TABLE `group_post_file` ADD CONSTRAINT `FK_image_TO_group_post_file_1` FOREIGN KEY (
	`file_id`
)
REFERENCES `image` (
	`file_id`
...
ALTER TABLE `prom_file` ADD CONSTRAINT `FK_promotion_TO_prom_file_1` FOREIGN KEY (
	`prom_id`
)
REFERENCES `promotion` (
	`prom_id`
...
ALTER TABLE `prom_file` ADD CONSTRAINT `FK_promotion_TO_prom_file_2` FOREIGN KEY (
	`user_id`
)
REFERENCES `promotion` (
	`user_id`
...
ALTER TABLE `prom_file` ADD CONSTRAINT `FK_image_TO_prom_file_1` FOREIGN KEY (
	`file_id`
)
REFERENCES `image` (
	`file_id`
...
ALTER TABLE `report_comment` ADD CONSTRAINT `FK_user_TO_report_comment_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `review_file` ADD CONSTRAINT `FK_review_TO_review_file_2` FOREIGN KEY (
	`user_id`
)
REFERENCES `review` (
	`user_id`
...
ALTER TABLE `review_file` ADD CONSTRAINT `FK_review_TO_review_file_3` FOREIGN KEY (
	`store_id`
)
REFERENCES `review` (
	`store_id`
...
ALTER TABLE `review_file` ADD CONSTRAINT `FK_image_TO_review_file_1` FOREIGN KEY (
	`file_id`
)
REFERENCES `image` (
	`file_id`
...
ALTER TABLE `review_like` ADD CONSTRAINT `FK_review_TO_review_like_2` FOREIGN KEY (
	`store_id`
)
REFERENCES `review` (
	`store_id`
...
ALTER TABLE `group_post_comment_like` ADD CONSTRAINT `FK_group_post_comment_TO_group_post_comment_like_1` FOREIGN KEY (
	`comment_id`
)
REFERENCES `group_post_comment` (
	`comment_id`
);

ALTER TABLE `group_post_comment_like` ADD CONSTRAINT `FK_group_post_comment_TO_group_post_comment_like_2` FOREIGN KEY (
	`post_id`
)
REFERENCES `group_post_comment` (
	`post_id`
...
ALTER TABLE `group_post_comment_like` ADD CONSTRAINT `FK_group_post_comment_TO_group_post_comment_like_3` FOREIGN KEY (
	`group_id`
)
REFERENCES `group_post_comment` (
	`group_id`
...
ALTER TABLE `group_post_comment_like` ADD CONSTRAINT `FK_user_TO_group_post_comment_like_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `group_member_waiting` ADD CONSTRAINT `FK_group_TO_group_member_waiting_1` FOREIGN KEY (
	`group_id`
)
REFERENCES `group` (
	`group_id`
...
ALTER TABLE `group_member_waiting` ADD CONSTRAINT `FK_user_TO_group_member_waiting_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_post` ADD CONSTRAINT `FK_user_TO_user_post_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_post_comment` ADD CONSTRAINT `FK_user_post_TO_user_post_comment_1` FOREIGN KEY (
	`post_id`
)
...
ALTER TABLE `user_post_comment` ADD CONSTRAINT `FK_user_TO_user_post_comment_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_post_comment_like` ADD CONSTRAINT `FK_user_post_comment_TO_user_post_comment_like_1` FOREIGN KEY (
	`comment_id`
)
REFERENCES `user_post_comment` (
	`comment_id`
);

ALTER TABLE `user_post_comment_like` ADD CONSTRAINT `FK_user_post_comment_TO_user_post_comment_like_2` FOREIGN KEY (
	`post_id`
)
REFERENCES `user_post_comment` (
	`post_id`
...
ALTER TABLE `user_post_comment_like` ADD CONSTRAINT `FK_user_TO_user_post_comment_like_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `group_post_report` ADD CONSTRAINT `FK_user_TO_group_post_report_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_post_report` ADD CONSTRAINT `FK_user_TO_user_post_report_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_comment_report` ADD CONSTRAINT `FK_user_TO_user_comment_report_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `group_post_comment_report` ADD CONSTRAINT `FK_user_TO_group_post_comment_report_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `review_report` ADD CONSTRAINT `FK_user_TO_review_report_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_post_file` ADD CONSTRAINT `FK_user_post_TO_user_post_file_1` FOREIGN KEY (
	`post_id`
)
REFERENCES `user_post` (
	`post_id`
...
ALTER TABLE `user_post_file` ADD CONSTRAINT `FK_user_post_TO_user_post_file_2` FOREIGN KEY (
	`user_id`
)
REFERENCES `user_post` (
	`user_id`
...
ALTER TABLE `user_post_file` ADD CONSTRAINT `FK_image_TO_user_post_file_1` FOREIGN KEY (
	`file_id`
)
REFERENCES `image` (
	`file_id`
...
ALTER TABLE `user_post_like` ADD CONSTRAINT `FK_user_TO_user_post_like_1` FOREIGN KEY (
	`user_id`
)
REFERENCES `user` (
	`user_id`
...
ALTER TABLE `user_post_like` ADD CONSTRAINT `FK_user_post_TO_user_post_like_1` FOREIGN KEY (
	`post_id`
)
REFERENCES `user_post` (
	`post_id`
