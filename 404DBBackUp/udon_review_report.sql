...
CREATE TABLE `review_report` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `FK_user_TO_review_report_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `review_report` VALUES ('ssafy2','광고리뷰에요','광고리뷰',44,1234);
...
-- Dump completed on 2021-02-25 16:03:28
